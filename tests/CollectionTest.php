...
/*
 * Modified version of SupportCollectionTest in "illuminate/support" by Taylor Otwell
 */

use Mockery as m;
use SammyK\FacebookQueryBuilder\Collection;
...
class CollectionTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $item1 = m::mock('SammyK\FacebookQueryBuilder\Collection');
        $item1->shouldReceive('toArray')->once()->andReturn('foo.array');
        $item2 = m::mock('SammyK\FacebookQueryBuilder\Collection');
    ...
    {
        $c = $this->getMock('SammyK\FacebookQueryBuilder\Collection', array('toArray'));
    ...
    public function testChunk ()
    {
        ...
        $this->assertInstanceOf('SammyK\FacebookQueryBuilder\Collection', $data);
        $this->assertInstanceOf('SammyK\FacebookQueryBuilder\Collection', $data[0]);
