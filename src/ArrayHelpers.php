...
/*
 * Modified version of helpers.php in "illuminate/support" by Taylor Otwell
 */
...
class ArrayHelpers
{
    ...
    public static function data_get($target, $key, $default = null)
    {
        if (is_array($target))
        {
            return self::get($target, $key, $default);
        }
        else
        {
            throw new \InvalidArgumentException("Array must be passed to data_get.");
        }
    }
}
