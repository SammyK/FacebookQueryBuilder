...
An example endpoint that supports modifiers is the [`/{object-id}/comments` edge](https://developers.facebook.com/docs/graph-api/reference/v2.5/object/comments#readmodifiers).
...
```php
$request = $fqb->node('me')->graphVersion('v2.5');
